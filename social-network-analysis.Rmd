...
Likely can't use linear regression bc network data violates assumptions of independence of observations. But here goes. 


```{r}

summary(lm(degree_out ~ nodeAge, data = law_centrality)) 
summary(lm(degree_out ~ nodeAge, data = law_centrality)) 
summary(lm(strength ~ nodeGender, data = law_centrality)) 
